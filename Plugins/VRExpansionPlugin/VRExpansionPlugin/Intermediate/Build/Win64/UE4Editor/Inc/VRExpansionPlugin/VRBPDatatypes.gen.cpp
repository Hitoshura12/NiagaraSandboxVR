...
// End Cross Module References
	...
	static UEnum* EVRClientAuthConflictResolutionMode_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_VRExpansionPlugin_EVRClientAuthConflictResolutionMode, Z_Construct_UPackage__Script_VRExpansionPlugin(), TEXT("EVRClientAuthConflictResolutionMode"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EVRClientAuthConflictResolutionMode(EVRClientAuthConflictResolutionMode_StaticEnum, TEXT("/Script/VRExpansionPlugin"), TEXT("EVRClientAuthConflictResolutionMode"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_VRExpansionPlugin_EVRClientAuthConflictResolutionMode_Hash() { return 1099879852U; }
	UEnum* Z_Construct_UEnum_VRExpansionPlugin_EVRClientAuthConflictResolutionMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_VRExpansionPlugin();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EVRClientAuthConflictResolutionMode"), 0, Get_Z_Construct_UEnum_VRExpansionPlugin_EVRClientAuthConflictResolutionMode_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
