...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Users_SG_Desktop_UNREAL_NiagaraSandboxVR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_SG_Desktop_UNREAL_NiagaraSandboxVR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVRBasePlayerController, AVRBasePlayerController::StaticClass, TEXT("AVRBasePlayerController"), &Z_Registration_Info_UClass_AVRBasePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVRBasePlayerController), 4284467193U) },
		{ Z_Construct_UClass_AVRPlayerController, AVRPlayerController::StaticClass, TEXT("AVRPlayerController"), &Z_Registration_Info_UClass_AVRPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVRPlayerController), 3992642460U) },
		{ Z_Construct_UClass_UVRLocalPlayer, UVRLocalPlayer::StaticClass, TEXT("UVRLocalPlayer"), &Z_Registration_Info_UClass_UVRLocalPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVRLocalPlayer), 31177312U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_SG_Desktop_UNREAL_NiagaraSandboxVR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_3297524304(TEXT("/Script/VRExpansionPlugin"),
		Z_CompiledInDeferFile_FID_Users_SG_Desktop_UNREAL_NiagaraSandboxVR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_SG_Desktop_UNREAL_NiagaraSandboxVR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRPlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
